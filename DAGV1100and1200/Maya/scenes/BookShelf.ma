...
//Name: BookShelf.ma
//Last modified: Fri, May 29, 2026 10:51:44 PM
//Codeset: UTF-8
requires maya "2027";
...
fileInfo "UUID" "C81E3031-1243-92F3-7C4E-6890F32F4401";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 33.602064454442115 5.3398815731682099 67.101772168401382 ;
	setAttr ".r" -type "double3" 0.26164727039776753 26.600000000000389 1.3894741211967037e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "A0544209-9E45-AF9D-B7C8-B88038E755FC";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 75.045746110066389;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "9F8301AF-A745-130C-5452-6B83A65C80C9";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "352839C1-B44B-D5E4-3166-98B87A8535E7";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "D740456F-1C4F-1084-AF87-F3B50D348831";
createNode displayLayerManager -n "layerManager";
	rename -uid "AF8F5261-C14C-87D1-A299-AE8EA54896D1";
createNode displayLayer -n "defaultLayer";
	rename -uid "CAFB8F85-F448-AF94-E789-ED82C3D93986";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F5360807-874C-DD5A-062E-D7900F276260";
