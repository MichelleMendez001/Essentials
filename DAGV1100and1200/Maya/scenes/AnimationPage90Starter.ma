...
//Last modified: Sat, May 16, 2026 03:43:57 PM
//Codeset: UTF-8
requires maya "2027";
...
fileInfo "UUID" "1CB676A8-AE47-A905-DD48-719947199C44";
createNode transform -s -n "persp";
	rename -uid "1DFBA4A4-134A-59AA-2739-3C93ABFFD067";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -12.104473692087986 13.798827918340098 52.430235768206856 ;
	setAttr ".r" -type "double3" -6.9383527296036362 -12.99999999999463 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "8426FD61-B94B-9F60-1746-D0BED0796422";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 54.206335481247315;
...
createNode transform -n "Hand" -p "Elbow";
	...
	setAttr ".t" -type "double3" 0 0.19917012448132781 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "022ADD5A-4F4A-85F6-3F66-66ABF1A56B74";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "D68432C8-4048-D692-36D7-B7AE328F5021";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "BCFAE444-9340-CAAC-8B2E-15AF8D13C368";
createNode displayLayerManager -n "layerManager";
	rename -uid "F1E9803F-AB47-EE94-97BF-F296B3F9B526";
createNode displayLayer -n "defaultLayer";
	rename -uid "138E985A-7348-29D9-3700-8797FCF8ABC7";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "67968247-3749-053B-C691-C79F074870C5";
...
createNode animCurveTA -n "Arm_rotateZ";
	rename -uid "15CD8B53-DF40-ED96-5B27-E9B675E84D05";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 50 13 -50 25 50;
createNode animCurveTA -n "Elbow_rotateZ";
	rename -uid "D200801D-A642-46C7-0101-229856FF709E";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 50 13 -50 25 50;
createNode animCurveTA -n "Hand_rotateZ";
	rename -uid "EFE6B393-7144-12BF-7920-9798E64B0AD6";
	setAttr ".tan" 18;
	setAttr -s 5 ".ktv[0:4]"  1 47.261410788381745 7 110 13 -44.273858921161931
		 21 -64.813278008298838 25 62.323651452282157;
	setAttr -s 5 ".kit[3:4]"  1 1;
	setAttr -s 5 ".kot[3:4]"  1 1;
	setAttr -s 5 ".kix[3:4]"  0.24120879103429615 0.36428571672877308;
	setAttr -s 5 ".kiy[3:4]"  2.4977761347179559 0;
	setAttr -s 5 ".kox[3:4]"  0.24120880934422201 0.36428566220167935;
	setAttr -s 5 ".koy[3:4]"  2.4977764101785551 -2.5068280930715498e-08;
createNode animCurveTU -n "Hand_visibility";
	rename -uid "025ACF47-F742-3A42-8CEA-44B337590C8F";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  7 1;
	setAttr ".kot[0]"  5;
